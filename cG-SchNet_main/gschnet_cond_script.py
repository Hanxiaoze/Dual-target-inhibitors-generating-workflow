...
def get_parser():
    ...
    train_parser.add_argument('--logger',
                              ...
                              default='tensorboard')  #tensorboard
    ...
    gschnet_parser.add_argument('--dense_layers', type=int,
                                ...
                                default=5)  # 5
    gschnet_parser.add_argument('--cutoff', type=float, default=10.,    #10.
    ...
    gschnet_parser.add_argument('--num_gaussians', type=int, default=25,
                                help='Number of Gaussians to expand distances '
                                     '(default: %(default)s)')
    gschnet_parser.add_argument('--max_distance', type=float, default=30.,  #15.
                                help='Maximum distance covered by the discrete '
                                     'distributions over distances learned by '
                                     'the model '
                                     '(default: %(default)s)')
    gschnet_parser.add_argument('--num_distance_bins', type=int, default=300,  #300
