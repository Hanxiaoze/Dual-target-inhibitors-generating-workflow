...
# 输入文件夹和输出文件夹
input_folder = '/home/zhou/ZINC_data_bank/ZINC_in-man___3D_add_H___mol2___108314_files_lib'  # 替换为包含mol2文件的文件夹路径
output_folder = '/home/zhou/ZINC_data_bank/ZINC_in-man___3D_add_H___xyz_with_H_from_mol2_by_obabel___108314_files_lib'  # 替换为保存xyz文件的文件夹路径
...
def process_file(input_file):    
    ...
    output_file = os.path.join(output_folder, os.path.basename(input_file).replace('.mol2', f'.xyz'))
